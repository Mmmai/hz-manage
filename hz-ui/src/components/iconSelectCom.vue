<template>
    <el-dialog v-model="iconDialogVisible" title="请选择图标" width="80%" :before-close="handleClose" @open="beforeOpen">
        
        <el-tabs v-model="activeName" class="demo-tabs" >
    <el-tab-pane label="常用" name="elementIcon"></el-tab-pane>
    <el-tab-pane label="其它" name="second"></el-tab-pane>

    <div style="display: flex;flex-wrap: wrap" >
            <div v-for="(name, index) in iconsObj[activeName]" :index="index" :key="index"
                style="cursor: pointer; padding: 5px; border: 1px solid rgb(227,232,232);"
                :class="currentIconName === name ? 'red' : ''" @click="selectIcon(name)">
